...
void main(){
    int switcher, choice;
    // system("cls");
    printf("\n<><><><><><> DATA OF THE HARVEST AREA, PRODUCTION AND PRODUCTIVITY OF CORN BASED ON PROVINCES (2020-2024) <><><><><><>\n");
    printf("\nHello there! Please select what do you want to do today\n");
    printf("1. See the Raw Data & Average\n2. See the Sorted Data\n3. Search for the data of a specific province\n4. See Indonesia's Total Data\n5. Highest & Lowest\n6. Exit\n");
    printf("Insert choice: ");
    scanf("%d", &switcher);
    switch(switcher){
        case(1):
            printf("=====================\nRAW DATA\n=====================");
            printf("\n1. See the Raw Data of the Corn Harvest Area\n2. See the Raw Data of the Production of Corn\n3. See the Raw Data of the Productivity of Corn\n4. Return\n");
            printf("Choose: ");
            scanf("%d", &choice);
            switch(choice){
                case(1):
        ...
        case(2):
            printf("=====================\nSORTED DATA\n=====================");
            printf("\n1. See the Sorted Data of the Corn Harvest Area\n2. See the Sorted Data of the Production of Corn\n3. See the Sorted Data of the Productivity of Corn\n4.Return\n");
            printf("Choose: ");
            scanf("%d", &choice);
            switch(choice){
                case(1):
        ...
        case(5):
            printf("=====================\nSee hIGHs & LOWs\n=====================");
            printf("\n1. Highs & Lows of Harvest Area\n2. Highs & Lows of Production of Corn\n3. Highs & Lows of Productivity of Corn\n4. Return\n");
            printf("Choose: ");
            scanf("%d", &choice);
            switch(choice){
                case(1):
